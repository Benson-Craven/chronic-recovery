...
const Navbar = ({ className }: NavbarProps) => {
    ...
    useEffect(() => {
        document.body.style.overflow =
            isActive || isSubmenuOpen ? "hidden" : "auto"
            ...
            <div className="flex w-full items-center justify-between">
                        ...
                        {isSubmenuOpen && (
                            <>
                                ...
                                <motion.div
                                    ...
                                    exit="exit"
                                >
                                    <div className="flex flex-col space-y-4 p-8 pt-12">
                                        <Link
                                            href="/"
                                            onClick={toggleSubmenu}
                ...
                <AnimatePresence>
                    {isActive && (
                        ...
                        >
                            <motion.div
                                className="z-50 w-[80%] max-w-5xl rounded-[25px] border-2 border-black bg-textSecondary shadow-lg md:absolute md:left-1/2 md:top-1/2 md:-translate-y-1/2 md:translate-x-96"
