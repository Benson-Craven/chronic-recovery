    ...
    <nav className={navbarClassName}>
      <div className="flex w-full items-center justify-between">
        ...
        <AnimatePresence>
          {isActive && (
            <motion.div
              className="fixed inset-0 z-50 flex items-start justify-end md:justify-center"
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
              exit={{ opacity: 0 }}
            >
              <motion.div
                className="absolute top-20 right-20 z-50 flex w-[80%] max-w-5xl flex-col rounded-[25px] border-2 border-black bg-textSecondary shadow-lg md:left-1/2 md:top-1/2 md:-translate-x-1/2 md:-translate-y-1/2"
